...
A blog application built on Node.js & Express.js rendered on Jade. I used Bootstrap on the front-end and PostgreSQL as the database. Implemented local strategy authentication using Passport.js. 
